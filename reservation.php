...
<body>
  ...
  <p>
    <form method='post' action='traitement.php'>
      ...
      <input type='text' name='Destination' id='Destination' <?php echo $Destination; ?> /> <?php if (isset($DestinationErr) ){
		 echo $DestinationErr; 
	  } else {echo $DestinationErr="";} ?>

      <br/><br/>
      <label for='Nombre_de_places'>Nombre de places</label>
      <input type='number' name='Nombre_de_places' id='Nombre_de_places' <?php echo $Nombre_de_places; ?> /> <?php if(isset($Nombre_de_placesErr)){
		  echo $Nombre_de_placesErr;
	  } else{ $Nombre_de_placesErr="";}  ?>

      <br/><br/>
      <label for='Assurance_annulation'>Assurance annulation</label>
      <input type='checkbox' name='Assurance_annulation' id ='Assurance_annulation' /> <?php if (isset($Assurance_annulationErr)){
		echo $Assurance_annulationErr;  
	  } else{echo $Assurance_annulationErr="";}  ?>

      <br/><br/>
      <input type='submit' name='Etape_suivante' value='Etape suivante' onclick ="<?php $Etape_suivante=1;?>" <?php $Etape_suivante=0;?> >
